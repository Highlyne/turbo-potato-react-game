    ...
    render() {
        return (
            ...
            <div className="playArea">
                ...
                <Playbox boxAmount={this.props.gameState.box1amount} clickSum={this.props.clickSum} paddle="./images/pinkEgg.png" />
                <Playbox boxAmount={this.props.gameState.box2amount} clickSum={this.props.clickSum} paddle="./images/yelloEgg.png"/>
                <Playbox boxAmount={this.props.gameState.box3amount} clickSum={this.props.clickSum} paddle="./images/purpleEgg.png"/>
